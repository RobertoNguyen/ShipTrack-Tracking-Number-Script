...
Sub testShipTrack()
   ...
   'Next i
    ...
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "Tracking") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "Status") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "Delivered") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "RecBy") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "ShipTo") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "ServiceLvl") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "Origin") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "Manifest") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "Scheduled") & "-"
    Debug.Print "-" & ShipTrack(vTracking, sCarrier, "TimeStamp") & "-"
